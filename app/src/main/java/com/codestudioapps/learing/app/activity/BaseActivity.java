...
import com.codestudioapps.learing.app.BlogActivity;
import com.codestudioapps.learing.app.ContactActivity;
import com.codestudioapps.learing.app.Gallery;
import com.codestudioapps.learing.app.ReunionActivity;
import com.codestudioapps.learing.app.SchoolActivity;
...
public class BaseActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, DialogUtilities.OnCompleteListener {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_quiz) {
            ...
            ActivityUtilities.getInstance().invokeNewActivity(mActivity, MainActivity.class, false);
        } else if (id == R.id.action_settings) {
            ActivityUtilities.getInstance().invokeNewActivity(mActivity, ContactActivity.class, false);
            ...
            ActivityUtilities.getInstance().invokeNewActivity(mActivity, ReunionActivity.class, false);
        }else if (id == R.id.action_gallery){
            ActivityUtilities.getInstance().invokeNewActivity(mActivity, Gallery.class, false);
        }else if(id == R.id.action_blog){
            ActivityUtilities.getInstance().invokeNewActivity(mActivity, BlogActivity.class, false);
        }else if(id == R.id.action_school){
            ActivityUtilities.getInstance().invokeNewActivity(mActivity, SchoolActivity.class, false);
        }
